...
\begin{tikzcd}
  \langle \dots \rangle \arrow{rr}{[Lam-Elim]} & & \langle M_i;\ \Gamma_i;\ \Delta_i \rangle \arrow{d}{exp}
...
\item $(BVar)$
  ...
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$\lambda x$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$x$}\ \ \tikzmark{5}{$=$}\ \ \tikzmark{6}{$e$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{red}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{green}\draw[->] (4.south) to[bend left] (3.south);}
    {\color{brown}\draw[<-]   ($(4.north)+(0,0.5)$)
      node[above,align=left,black] {$i$}  -- (4);}
    {\color{green}\draw[->] (6.south) to[bend left] (2.south);}
    {\color{brown}\draw[<-]   ($(4.north)+(0.1,0.5)$)
      node[above,align=left,black] {$$}  -- (6);}
  \end{tikzpicture}
...
\item $(Lam-Non-Elim)$
  ...
  \begin{tikzpicture}[remember picture,overlay]
    {\color{blue}\draw[->] (3.north) to[bend right] (2.north);}
  \end{tikzpicture}
  $\longrightarrow$ where $e$ is a right child of $@$ \\ \\
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$\lambda x$}\ \ \tikzmark{4}{$e$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{blue}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{blue}\draw[->] (4.north) to[bend right] (2.north);}
  \end{tikzpicture}
  \\ \\
\item $(Lam-Elim)$
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$\lambda x$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{blue}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{brown}\draw[->] (4.north) to[bend right] (3.north);}
  \end{tikzpicture}
  $\longrightarrow$ where $e$ is a child of $\lambda x$ \\ \\
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$\lambda x$}\ \ \tikzmark{5}{$e$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{blue}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{brown}\draw[->] (4.north) to[bend right] (3.north);}
    {\color{blue}\draw[->] (5.north) to[bend right] (2.north);}
  \end{tikzpicture}
\item $(App)$
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@$}\]
  $\longrightarrow$ where $e$ is a left child of $@$ \\ \\
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@$}\ \ \tikzmark{3}{$e$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{brown}\draw[->] (3.north) to[bend right] (2.north);}
  \end{tikzpicture}
\item $(FVar-0)$
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$y$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{violet}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{brown}\draw[->] (4.north) to[bend right] (3.north);}
  \end{tikzpicture}
  $\longrightarrow$ where $e$ is a right child of $@_2$ \\ \\
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$y$}\ \ \tikzmark{}{$||$}\ \ \tikzmark{5}{$e$}\]
  \begin{tikzpicture}[remember picture,overlay]
    {\color{violet}\draw[->] (3.north) to[bend right] (2.north);}
    {\color{brown}\draw[->] (4.north) to[bend right] (3.north);}
    {\color{violet}\draw[->] (5.north) to[bend right] (2.north);}
  \end{tikzpicture}
\item $(FVar-1)$
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$y$}\]
  \begin{tikzpicture}[remember picture,overlay]

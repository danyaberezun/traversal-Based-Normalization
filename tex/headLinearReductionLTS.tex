...
\item $(Lam-Non-Elim)$
  ...
  \begin{tikzpicture}[remember picture,overlay]
    {\color{violet}\draw[dashed,line width=0.5mm,|->] (3.north) to[bend right] (2.north);}
    {\color{violet}\draw[dashed,line width=0.5mm,|->] (13.north) to[bend right] (12.north);}
    {\color{violet}\draw[dashed,line width=0.5mm,|->] (14.north) to[bend right] (12.north);}
  \end{tikzpicture}
  \\ \\
\item $(Lam-Elim)$
...
\item $(FVar-0)$
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    {\color{violet}\draw[dashed,line width=0.5mm,|->] (13.north) to[bend right] (12.north);}
    {\color{brown}\draw[solid,line width=1mm,->] (14.north) to[bend right] (13.north);}
    {\color{violet}\draw[dashed,line width=0.5mm,|->] (15.north) to[bend right] (12.north);}
  \end{tikzpicture}
\item $(FVar-1)$
  \[\tikzmark{1}{}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{2}{$@_1$}\ \ \tikzmark{}{$\dots$}\ \ \tikzmark{3}{$@_2$}
  \ \ \tikzmark{}{$\dots$}\ \ \tikzmark{4}{$y$}
